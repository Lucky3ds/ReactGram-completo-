...
const Profile = () => {
  ...
  const resetMsg = useResetMessage()
        ...
        <div className="profile-description">
          ...
          {id === userAuth._id &&(
            ...
            <form onSubmit={submitHandle}>
             ...
             {!loadingPhoto &&  <input type="submit" className="btn-p" value="Postar" />}
             {loadingPhoto &&  (
             <input type="submit" className="btn-p" disabled value="Aguarde..." />
             )}
            ...
            <div className="edit-photo hide" ref={editPhotoForm}>
              ...
              <form onSubmit={handleUpdate}>
                ...
                <input type="submit" className="btn-p"  value="Atualizar" />
                <button className="cancel-btn btn-p" onClick={handleCancelEdit}>Cancelar edição</button>
              </form>
            </div>
